...
/**
 * Re-exported API types matching the shacl-core package.
 * Kept locally to avoid cross-package import issues in Angular build.
 */
...
/** Frontend step model for the wizard stepper */
